...
barplot_absorbedPAR(mean_values_high, 'High', 'plots/total_absorbedPAR_high_density.png')

# Plot for low-density data
barplot_absorbedPAR(mean_values_low, 'Low', 'plots/total_absorbedPAR_low_density.png')
